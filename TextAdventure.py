...
while i < 10:
    ...
    if FoodChoice == ''2'':
        ...
        if FoodChoice != '1'or FoodChoice != '2' or EatOrWait != '1'or EatOrWait != '2' or EatOrLeave != '1'or EatOrLeave != '2' or MealOrCook != '1'or MealOrCook != '2' or StomachPain != '1'or StomachPain != '2' or BoyOrWait != '2' or BoyOrWait != 1:
