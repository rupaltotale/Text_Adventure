...
while i < 10:
    ...
    if FoodChoice == '2':
        ...
        EatOrWait =str(input("Enter '1'to continue eating or '2' for waiting \n"))
        if EatOrWait == '1':
            print("You are not full. Do you sit there hungry or leave your date and eat somewhere else?")
            EatOrLeave =str(input("Enter '1'to sit there hungry throughout the date or '2' to leave your date\n"))
            if EatOrLeave == '1':
        ...
        if EatOrWait == '2':
            ...
            MealOrCook =str(input("Enter '1'to wait or '2' to go home \n"))
            if MealOrCook == '1':
        ...
        if FoodChoice != 1 or FoodChoice != 2 or EatOrWait != 1 or EatOrWait != 2 or EatOrLeave != 1 or EatOrLeave != 2 or MealOrCook != 1 or MealOrCook != 2 or StomachPain != 1 or StomachPain != 2 or BoyOrWait != 1 or BoyOrWait != 2:
